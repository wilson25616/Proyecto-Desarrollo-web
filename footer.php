                ...
                <footer><!-- footer content -->
                    <div class="pull-right">
                        This project is created using <a target="_blank" style="color: #0000ff" href="">Web Project Builder. </a>An online php code builder tool By <a style="color: #0000ff; text-decoration: underline;" target="_blank" href="http://github.com/amnersaucedososa">Abisoft</a>
                    </div>
